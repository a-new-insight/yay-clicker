...
const upgrades = {
  yippee: { cost: 15, cps: 0.1 },
  yahoo: { cost: 100, cps: 1 },
  woo: { cost: 1500, cps: 10 },
  wahoo: { cost: 20000, clickBoost: 0.05 },
  yippeekayay: { cost: 100000, cps: 100 }
};
...
function incrementScore() {
  ...
  localStorage.setItem('score', String(Math.floor(score)));
  scoreDisplay.innerHTML = `${Math.floor(score)} yays`;
  updateNews();
  checkAchievements();
}
